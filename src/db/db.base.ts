...
export const pessoas: Pessoa[] = [
    new Pessoa(1, "Breno", "Nery", "(32) 9999-8888"),
    new Pessoa(2, "Antonio", "Ferreira", "(32) 9999-8888"),
    new Pessoa(3, "Maria", "Karlan", "(32) 9999-8888"),
    new Pessoa(4, "José", "Lourenço", "(32) 9999-8888"),
    new Pessoa(5, "Marcos", "Filho", "(32) 9999-8888")
];
...
export const livrosAltas: Livro[] = [
    ...
    new Livro(2, "O Senhor dos Anéis",
        new Autor(5, "J. R. R.", "Tolkien", "03/01/1892"), "1954",
            new Editora(1, "Altas", "Rua Teste Amorim", null)
    )
];
